...
export default function ReviewsPage() {
  return (
    <PublicLayout>
      <section className="flex min-h-[50vh] items-center justify-center bg-[#dcebc8] px-4 py-16 text-center">
        <h1 className="rounded-md bg-white/30 px-6 py-4 text-4xl font-semibold shadow-sm">
          What Our Customers Say
        </h1>
      </section>

      <section className="mx-auto grid max-w-5xl gap-8 px-4 py-14 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <div className="mt-5 text-4xl font-bold">
                4.9 <span className="text-2xl text-[#ffd700]">★★★★★</span>
              </div>
              <a
                href={source.href}
                target="_blank"
                rel="noreferrer"
                className="mt-5 rounded-md bg-[#315c46] px-5 py-3 text-sm font-semibold text-white hover:bg-[#263f32]"
              >
